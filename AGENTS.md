...
This file provides brand context and routing rules for AI coding agents (Codex, Gemini CLI, and others). For Claude Code users, see `CLAUDE.md` — the content is identical.
